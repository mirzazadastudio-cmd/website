...
import {projectCategories,projectTopics} from './projects';
import {CATALOG_VERSION} from './catalog-upgrade';
import {validateProjectDetails} from './project-validation';
import {validateEditorial} from './editorial-validation';
...
export function validateContent(raw:unknown):SiteContent{
 ...
 return {catalogVersion:CATALOG_VERSION,projectRedirects,projects,settings,crops,...validateEditorial(d,image,projects)};
}

...
import { projects, projectCategories } from './projects.ts';
import previousCatalog from './catalog-v1.json' with {type:'json'};
import crops from './image-crops.json' with {type:'json'};
import catalogV2 from './catalog-v2.json' with {type:'json'};
import {defaultCollections} from './collections.ts';
import {hasCategory} from './projects.ts';

...
import {JournalTeaser} from '@/components/journal';
...
export default function Home() {
 ...
 const filtered=activeCollection?collectionProjects(projects,activeCollection):projects;
 const visible=expanded||filter!=='All projects'?filtered:filtered.slice(0,12);
 return <><Header/><main id="main"><ProjectReel/>
 ...
 <JournalTeaser/><Contact/></main><Footer/></>;
}

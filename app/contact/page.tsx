...
export default function ContactPage(){return <><Header/><main id="main"><section className="section inquiry-section"><div><p className="eyebrow">START A CONVERSATION</p><h1>A new project.<br/><span>A shared perspective.</span></h1><p>Share the context, the spaces and the images you need. We’ll use your brief to discuss the right scope for the project.</p><a href="mailto:hello@mirzazadastudio.com" className="text-link">hello@mirzazadastudio.com ↗</a></div><InquiryForm/></section><Contact/></main><Footer/></>;}
